...
class GroupMember(models.Model):
    ...
    position_in_group_at_start = models.PositiveSmallIntegerField(unique=True, help_text='Enter the position in the group at the starte')
    code_position_start = models.CharField(max_length=2, unique=True, editable=False, default='')

    class Meta:
        ordering = ['group', 'team']

    def save(self, *args, **kwargs):
        self.code_position_start = self.group.name[-1] + str(self.position_in_group_at_start)
        super().save(*args, **kwargs)
